...
const Home: NextPage = () => {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen justify-center gap-10">
      <Head>
      ...
      <main className="grid grid-cols-1 place-content-center gap-8">
        ...
        {!data && <Spinner className="text-indigo-600" />}
